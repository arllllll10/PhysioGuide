...
class HealthManager
{
    ...
    func saveCalorySample(calory : Double, date :NSDate, dur: Int)
    {
        ...
        let start = date.dateByAddingTimeInterval(-durInSeconds)
        ...
        let workout = HKWorkout(activityType: HKWorkoutActivityType.Running, startDate: start, endDate: date, duration: durDouble, totalEnergyBurned: caloryQuantity, totalDistance: dist, metadata: nil)
